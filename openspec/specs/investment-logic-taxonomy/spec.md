# investment-logic-taxonomy Specification

## Purpose
Defines the canonical investment reasoning taxonomy used to classify why a signal may matter before downstream chokepoint-map lookup or target mapping.
